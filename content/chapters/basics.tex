...
Das dritte Merkmal ist der Konflikt innerhalb der Spiele. Er entsteht aus dem Zusammenspiel von Zielverfolgung und Widerständen. Er liegt vor, wenn ein intelligenter, reaktionsfähiger Gegenspieler die Zielerreichung des Spielers aktiv behindert (vgl. \citealp[S. 11]{crawford_art_1984}). 

Das letzte Merkmal ist die Sicherheit. Darunter versteht \citeauthor{crawford_art_1984}, dass Spiele eine sichere Erfahrung von Gefahr und Konflikt ermöglichen. Physische Konsequenzen, auf ihre Taten in den Spielen, müssen die Spieler nicht fürchten (vgl. \citealp[S. 12]{crawford_art_1984}).
