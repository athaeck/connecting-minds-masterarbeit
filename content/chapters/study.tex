...
Die Länge der Probandentest könnte dazu geführt haben, dass weitere Probanden abgeschreckt wurden, da sie in einem längeren Szenario sitzen würden.
Über die Länge der Versuchsdurchführung lässt  sich streiten, allerdings ist diese auch begründet. Die Probanden müssen eine bestimmte Zeit lang gemeinsam eine Aufgabe bearbeiten damit genug von ihrer Kommunikation erfasst werden kann. Zudem darf der Prototyp in seiner Bearbeitungszeit nicht zu kurz angesetzt werden, da er sonst nicht rechtzeitig durchgespielt werden kann und auch seine Wirkung erst mit der Zeit entfalten lassen kann. Eine richtige Wirkung kann er nur entfalten, sobald Automatismen im Kommunikationsmuster antrainiert werden können. Einige male war es leider so, dass Probandenpaare die Labyrinthe vor dem Ende der 10 Minuten Grenze gelöst haben. Dadurch waren einige Tests unterschiedlich lang. Für weitere Szenarien müssen daher Aufgaben gegeben werden, die auch wirklich 10 Minuten andauern, oder weitere Labyrinthe enthalten.
