...
% Stichproben größe für Fragen zum Prototyp ausreichen

% Umfassende Recherche zu Fragebögen bezüglich Prototyp und wirkung ebenfalls erfolgreich, wenn auch irgendwann schwer zu differenzieren#

% fehlende Ergebnisse zu VBergleichsfragen zum Kern der mechanik, interdependence, sowas hat noch gefehlt was man hätter ergbänzen können

% umfassendere fragen zu den einzelnen themen für due qwualitative untersuchung bezüglich des prototyps: um mit einer frage alles abzudecken wurden bestimmte aspekte nicht abgefragt und womöglich vergessebn, wodurch eine qualitative auswertung zum prototyp nicht zu umfassend ausfiel

% zu mehreren zeitpüunkten datzenerhebungen durchführen damit ein verlauf verschiedener dimensionen messbar hätzten sein können; auch um zu sehen welcher teil der versuchsdurchführung welchen effekt hat, so ist momentan schwer zu sehen bei den fragebögen ,welche wirkung der prototyp hatte; außer jetzt beim vor nachtest, da sieht mans

% spielt da mit rein, bei den letzten fragebögen auch ein vorher nachher wäre gut gewesen

% insgesamt der Versuchsaufbau schwer als alleimnige person zu stämmen, gibt viele unsicherheitsfaktoren, viele einzelschreitte die gegangen werden müssen

% außerdem hätte ein rechner mehr genutzt werden sollen für die eingabe der Fragebögen von den Playern, da hier immer der internetzugang gewechselkt werden musste zwischen internet um ein google formular einzugeben und internet umim lokalen netz für den prototyp zu sein


Die folgende Diskussion betrachtet den geplanten und durchgeführten Versuchsaufbau und deren Erhebnungsintrumente kritisch. Sie zeigt entstandene sowie geplante Stärken und Schwächen auf und gibt Hinweise darauf, wie die Stärken weiter ausgebaut und die Schwächen minimiert werden können.

Zunächst wird auf die Datenerhebung und die Stichproben-Größe eingegangen.
Durch diverse Einladungsnachrichten über E-Mail und Instant-Messaging Programme konnten 14 freiwillige Probanden gefunden welche in ihrer Anzahl für die Fragebögen als eher ausreichend angesehen werden. Für die gesamte Versuchsdurchführung und die damit einhergehende Analyse der Kommunikationsprotokolle reichen 14 Probanden, a sieben Zweierpaare, jedoch nicht aus. In der Auswertung mancher Eigenschaften bezüglich der Kommunikationsmenge konnte aufgrund der geringen Stichprobe keine signifikanten Entwicklungen festgestellt werden. Um Aussagen durch die Fragebögen treffen zu können wäre eine eine Stichproben-Größe von 28 besser geeignet gewesen (vgl. \cite[S. 158]{cohen_power_1992}). Ausgehend von der errechneten Stichproben-Größe von \cite{turner_determining_2006} um alle Aspekte der Gebrauchstauglichkeit einer Anwendung zu identifizieren, reichte die Anzahl der freiwilligen Probanden aus. 

Bevor der finale Versuchsaufbau konzipiert werden konnte, musste zunächst eine Recherche betrieben werden, welche Aspekte über Fragebögen abgefragt werden können. Im zweiten Schritt musste differenziert werden, welche der gefundenen Fragebögen für den Prototyp und/ oder Versuchsaufbau notwendig sind. Darunter fiel auch das Aussortieren von doppelten Abfragegebieten. Bei der gefundenen Menge an Fragebögen, knapp 20 in der Anzahl, entwickelte sich schnell eine Unübersichtlichkeit. 
% 1. Fragebögen & Datenerhebung zum Prototyp
% % Stichproben größe für Fragen zum Prototyp ausreichen, für die gesammte Versuchsdurchführung nicht

% % Umfassende Recherche zu Fragebögen bezüglich Prototyp und Wirkung ebenfalls erfolgreich, wenn auch irgendwann schwer zu differenzieren

% % spielt da mit rein, bei den letzten Fragebögen auch ein Vorher-Nachher wäre gut gewesen

% % zu mehreren Zeitpunkten Datenerhebungen durchführen, damit ein Verlauf verschiedener Dimensionen messbar hätte sein können; auch um zu sehen, welcher Teil der Versuchsdurchführung welchen Effekt hat, so ist momentan schwer zu sehen bei den Fragebögen, welche Wirkung der Prototyp hatte; außer jetzt beim Vor-Nachtest, da sieht man’s

Im zweiten Schritt wird auf die Inhalte und Tiefe der Fragen in den Fragebögen eingegangen.
Bei der Wahl der Fragebögen wurde außer acht gelassen, dass ein Fragebogen zur Interdependence der Anwendungen noch relevant gewesen wäre, überprüfen zu können, wie stark oder lose die Abhängigkeit empfunden wird. Das Ergebnis dieses Fragebogens könnte helfen, die bestehenden Rätsel zu überarbeiten und einen Hinweis darauf zu geben, wie zukünftige Rätsel auszusehen haben. 

Inhaltlich fehlte den Fragebögen ein erweiterter Fragebogen um qualitatives Feedback der Probanden sammeln zu können. Bislang konnten die Probanden nur über eine Freitext Frage ihr Feedback mitteilen. Problematisch daran ist, dass diese Frage für alle möglichen Aspekte dienen kann. An dieser Stelle wäre sinnvoller gewesen, wenn verschiedene Fragen zu wichtigen Themen in der Arbeit mit dem Prototypen gestellt worden wären, damit die Probanden zielgerichteter angesprochen werden können.
% 2. Inhalte & Tiefe der Fragen im Fragebogen
% % fehlende Ergebnisse zu Vergleichsfragen zum Kern der Mechanik, Interdependence – sowas hat noch gefehlt, was man hätte ergänzen können

% % umfassendere Fragen zu den einzelnen Themen für die qualitative Untersuchung bezüglich des Prototyps: um mit einer Frage alles abzudecken, wurden bestimmte Aspekte nicht abgefragt und womöglich vergessen, wodurch eine qualitative Auswertung zum Prototyp nicht zu umfassend ausfiel

Im letzten Schritt wird auf die methodischen und technischen Herausforderungen im Ablauf eingegangen.
[es fehlt noch das eingehen auf mazescape]
Der Testaufbau für diese Versuchsdurchführung ist ziemlich groß und mit vielen Einzelschritten ausgefallen. Es mussten verschiedene Dinge beachtet werden. Die jeweiligen MazeScape Labyrinthe mussten in der richtigen Reihenfolge zusammengelegt werden, damit die Probanden-Paare ihren Vor- und Nachtest auch mit der richtigen Sortierung starten können. Außerdem musste im Android Build für das ausgeliehene Smartphone die richtige IP-Adresse des WebSocket Servers innerhalb der Anwendung referenziert werden. Zudem durfte der Laptop, auf dem der Express Server lief nicht ausgehen. Am Rechner des Players musste sorgsam darauf geachtet werden, dass jeweils immer der richtige Netzwerk Zugang für das entsprechende Szenario hinterlegt sein. Sobald die Probanden die Datenschutzerklärung unterschrieben haben, musste der Rechner mit einem Internet Zugang hinterlegt worden sein. Sobald es ans Testen des Prototyps ging, musste dieser auf das Netzwerk des TP-Link Routers gewechselt werden, aber das Google Form durfte dabei nicht aktualisiert werden. Der Internetzugang nach dem Spielen wieder auf das HFU-Netz zurückgestellt werden damit der Proband die weiteren Fragebögen ausfüllen kann. Diese Einzelschritte wären mit einem zusätzlichen Laptop hinfällig gewesen.

Nachdem die ersten zwei Tests auf nur 60 Minuten angesetzt wurden, bildete sich anfangs mit der Folgegruppe ein Stau, wodurch die Versuchszeit auf 75 Minuten verlängert wurde. Diese Ansetzung gab einen größeren Pufferzeitraum und gab den Probanden das Gefühl, sobald sie früher fertig waren auch ein besseres Gefühl. Allerdings schreckte sie auch potenzielle weitere Probanden ab, da sie in einem extrem langen Szenario sitzen würden. Über die Länge der Versuchsdurchführung lässt  sich streiten, allerdings ist diese auch begründet. Die Probanden müssen eine bestimmte Zeit lang gemeinsam eine Aufgabe bearbeiten damit genug von ihrer Kommunikation erfasst werden kann. Zudem darf der Prototyp in seiner Bearbeitungszeit nicht zu kurz angesetzt werden, da er sonst nicht rechtzeitig durchgespielt werden kann und auch seine Wirkung erst mit der Zeit entfalten lassen kann. Eine richtige Wirkung kann er nur entfalten, sobald Automatismen im Kommunikationsmuster antrainiert werden können.

Mit der Länge der Vor- und Nachtests geht auch die Transkription und Auswertung einher. Für die Aufnahmen der Vergleichstest wurde eine Transkriptions-Anwendung zur Hilfe genommen, die allerdings auf den in den Videos enthaltene Ton abhängig ist. Für den Versuchsaufbau wurde lediglich eine Kamera für die Aufnahme ausgeliehen. An einigen Stellen war der Ton der Kamera zu undeutlich, wodurch viele Abschnitte des Transkripts von Hand angelegt werden mussten (ca. 14 Tage Bearbeitungszeit). Für einen weiteren Aufbau muss zwingend ein Mikrofon für die Probanden ausgeliehen und in den Aufbau integriert werden, damit darüber das Gesprochene genauer dokumentiert werden kann.

Im alten Versuchsaufbau der vorangegangenen Ausarbeitung wurde das im Seminarraum stehende Smartboard für die Player-Anwendung verwendet. Dabei konnte beobachtet werden, dass die jeweiligen Probanden zu nah am Monitor standen und deshalb nicht den gesamten Blickwinkel, den sie zur Verfügung hatten, nutzten. Aus diesem Grund wurde ein kleinerer Touchmonitor (15 Zoll groß) für die Anwendung des Players verwendet. Auf diesem konnten die Probanden deutlich besser mit der Anwendung interagieren und hatten auch den gesamten Blickwinkel im Fokus.

Im Rahmen der Auswertung der Transkripte wurde nur der quantitative Ansatz von Nasir verfolgt, da dieser aus der Sicht des Wissens über das Thema Kommunikation handhabbarer war. Um wirklich auf qualitative Unterschiede der Kommunikation einzugehen, wäre eine Taxonomie, wie sie \cite{baykal_collaboration_2023} aufgestellt hat, nicht ausreichend genug um eine Entwicklung des Verhaltens messen zu können. Dafür würde es Hintergrundwissen in der Linguistik und Sprachwissenschaft voraussetzen. Die Wahl, nur allein auf das gewählt Verfahren zu setzen, konnte sich anhand der Ergebnisse (noch) nicht bewahrheiten, bei einer größeren Stichprobe vermutlich schon. Bei zukünftigen Forschungen wäre eine Kombination aus beiden Ansätzen denkbar möglich.

% Für eine weiterführende Forschung 

% [TODO: Zur Auswertung noch was schreioben, man habe priumär eine quanittiative auswertung der kommunikation gewählt da die qualitative AUswertung enorm aufwenig gewesen wäre und dann im detail aspekte wie linguistik oder üähnliches nicht mit analysiert werden konnte, was verlorenes potemnzial gewesne wäre, weshalb nur die quanititä berücksicht wurde]
% 3. Methodische & technische Herausforderungen im Ablauf
% % insgesamt der Versuchsaufbau schwer als alleinige Person zu stemmen, gibt viele Unsicherheitsfaktoren, viele Einzelschritte, die gegangen werden müssen; - Länge des Tests vermutlich abschreckend und auch dass man als Paar kommen musste

% % außerdem hätte ein Rechner mehr genutzt werden sollen für die Eingabe der Fragebögen von den Playern, da hier immer der Internetzugang gewechselt werden musste zwischen Internet, um ein Google-Formular einzugeben, und Internet im lokalen Netz für den Prototyp

% Auswertung der Probandentests im Sinne der Transkription sehr aufwendig und auch bei der Zuweisung der floor-holdings wären mittelwerte oder ähnliches von mehreren perspektiven statistisch besser geeignet
