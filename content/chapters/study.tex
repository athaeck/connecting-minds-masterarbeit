...
Beim dritten Rätsel (vgl. Abbildung \ref{fig:riddle-design-section00-02}) hatten mehrere Probanden Schwierigkeiten, das intendierte Muster korrekt zu entschlüsseln. Dafür lassen sich mehrere Ursachen identifizieren. Zum einen lenkte das Passwort-Panel neben der Tür zu sehr von der eigentlichen Rätselumgebung ab, wodurch zunächst fälschlicherweise nach Passwörtern gesucht wurde. Zum anderen lasen einige Watcher die Beschreibung des relevanten Objekts nicht oder nicht sorgfältig genug, obwohl diese Hinweise zur Lösung enthalten. Erst nach einem gezielten Hinweise wurde die Lösung des Rätsels deutlich. Zusätzlich lenkten die verschlossenen Korridore im Eingangsbereich zum Sicherheitsraum ab, wodurch zunächst versucht wurde, diese weiteren Räume zu öffnen.
