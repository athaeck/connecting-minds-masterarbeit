...
\newcommand{\docAbgabedatum}{30.07.2025}
\newcommand{\docErsterReferent}{Prof. Dr.-Ing. Thomas Schlegel}
%\newcommand{\docZweiterReferent}{-} % Wenn es nur einen Betreuer gibt
\newcommand{\docZweiterReferent}{Prof. Dipl.-Ing. Jirka Dell´Oro-Friedl}
